...
function HomePage() {
  ...
  return (
    <div
      className={`mx-auto my-8 mt-10 w-8/12 rounded border border-gray-200 p-4 text-center shadow-md dark:border-neutral-600 dark:bg-neutral-800 dark:shadow-none transform transition-all duration-700 ease-out 
        ${isVisible
    ...
    >
      <h1
        className={`mb-4 text-4xl font-bold transform transition-all duration-500 ease-out delay-200
          ${isVisible
      ...
      <p
        className={`my-4 transform transition-all duration-500 ease-out delay-[400ms]
          ${isVisible
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-4'
          }`}
      ...
      <p
        className={`my-4 text-muted-foreground transform transition-all duration-500 ease-out delay-[600ms]
          ${isVisible
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-4'
          }`}
      ...
      <div
        className={`mt-6 flex justify-center gap-4 transform transition-all duration-500 ease-out delay-[800ms]
          ${isVisible
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-4'
          }`}
